...
const program = new _command.default('bin/opensearch-dashboards-plugin');
program.version(_utils.pkg.version).description('The OpenSearch Dashboards plugin manager enables you to install and remove plugins that ' + 'provide additional functionality to OpenSearch Dashboards');
